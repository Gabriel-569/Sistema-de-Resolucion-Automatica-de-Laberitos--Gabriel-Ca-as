...
public class PanelLaberinto extends JPanel {
    ...
    // Método auxiliar para recalcular el tamaño del panel según la matriz actual
    private void actualizarDimensiones() {
        if (laberintoRef != null) {
            int ancho = laberintoRef.getColumnas() * tamanoCelda;
            int alto = laberintoRef.getFilas() * tamanoCelda;
    ...
    protected void paintComponent(Graphics g) {
        ...
        // 1. PRIMERA PASADA: Recorrer la matriz completa para renderizar Paredes y Pasillos
        ...
        for (Nodo nodo : grafo.getNodos()) {
            ...
            // Resaltar Entrada y Salida (comparando coordenadas para evitar fallos de instancia)
